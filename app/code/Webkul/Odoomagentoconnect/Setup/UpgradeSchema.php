    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.2.3', '<')) {
            $column1 = [
                ...
                'length' => 32,
                'nullable' => false,
                'comment' => 'Odoo Payment Id',
            ];
            $connection->addColumn($setup->getTable('odoomagentoconnect_payment'), 'odoo_payment_id', $column1);

            $column2 = [
                'type' => Table::TYPE_TEXT,
                'length' => 32,
                'nullable' => false,
                'comment' => 'Odoo Workflow Id',
            ];
            $connection->addColumn($setup->getTable('odoomagentoconnect_payment'), 'odoo_workflow_id', $column2);
        }
    }
}
